...
try{
	...
	include("connexion.inc.php");
		...
		// requete qui renvoie les enregistrements trier en décroissant pour pouvoir recuperer l'enregistrement precedent.
        $sql='select * from `MEDICAMENT` WHERE MED_DEPOTLEGAL<"'.$med_depotlegal.'" order by MED_DEPOTLEGAL DESC';
		// execute la requette
