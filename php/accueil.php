...
<html>
    ...
    <body <!-- Corps du document -->
        ...
        <div class="right">
            <img src='../images/banniere.png' id="logoConnecte" height="200">
            <div id="connected">
                <div class="row">
                    <div id="txtAccueil" class="col-6">
                        <h3>SECTEUR D'ACTIVITÉ</h3>
                        L’entreprise Galaxy Swiss Bourdin (GSB) créée en 2009 est le résultat de la fusion entre
                        l’entreprise américaine Galaxy et l’entreprise européenne Swiss Bourdin. L’entreprise
                        appartient à l’industrie pharmaceutique dans laquelle les regroupements de laboratoires
                        sont fréquents. Les récentes complications médicales dues à certains médicaments ou 
                        molécules, remettent en cause une partie de l’activité de ces laboratoires qui est la 
                        visite médicale. Elle constitue le lieu d’échange entre laboratoires et praticiens.
                    </div>
                    
                    <div class="col-6">
                        <img id="imgSecteur" src="../images/secteur.png" width="150" height="150">
                    </div>
                </div>
                ...
                <div class="row">
                    <div id="txtAccueil" class="col-6">
                        ...
                        L’aspect de la visite médicale est alors à améliorer pour répondre aux récentes complications 
                        médicale. Pour cela GSB dispose de 480 visiteurs médicaux répartis de toute la France en six 
                        secteurs géographique: Paris-centre, Sud, Nord, Ouest, Est, DTOM. Les visiteurs médicaux se 
                        chargent de présenter (vendre) des produits de qualité auprès de différents praticiens.
                        </br></br>
                        L’entreprise Galaxy Swiss Bourdin est une multinationale dont le siège social se situe à 
                        Philadelphie en Pennsylvanie Etat-Unis. Quant à l’entité Galaxy Swiss Bourdin Europe, le 
                        siège administratif se situe à Paris.
                    </div>
                    
                    <div class="col-6">
                        <img id="imgSecteur" src="../images/produits.jpg" width="150" height="150">
                    </div>
                </div>
            </div>
        </div>
